...
export default function SearchFilters({
  ...
  const STOCK_LABELS: Record<StockStatus, string> = {
    'En Stock': t('stockInStock'),
    Limité: t('stockLimited'),
    'Rupture de Stock': t('stockOutOfStock'),
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
        <h2 className="mb-4 text-base font-bold text-foreground">{t('heading')}</h2>

        <fieldset className="mb-5">
          <legend className="mb-2 text-sm font-medium text-foreground">{t('categories')}</legend>
        ...
        <fieldset className="mb-5">
          <legend className="mb-2 text-sm font-medium text-foreground">{t('availability')}</legend>
          <div className="space-y-2">
        ...
        <fieldset className="mb-5">
          <legend className="mb-2 text-sm font-medium text-foreground">{t('priceHeading')}</legend>
