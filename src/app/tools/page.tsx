    ...
    <div className="bg-background py-10 sm:py-16">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <header className="mb-10 text-center">
          <h1 className="text-2xl font-bold text-foreground sm:text-3xl">Contact & support</h1>
          <p className="mx-auto mt-2 max-w-2xl text-sm text-muted-foreground sm:text-base">
            Une question commerciale, un sujet technique ou un point sur votre abonnement ? Notre
            équipe est joignable via le formulaire ci-dessous. Pour les réponses rapides aux
            questions courantes, ouvrez l&apos;assistant.
          </p>
        </header>
